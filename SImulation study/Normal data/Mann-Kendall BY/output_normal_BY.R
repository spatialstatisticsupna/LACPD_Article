...
load("./part1_normal_BY.RData")
load("./part2_normal_BY.RData")
load("./part3_normal_BY.RData")
load("./false_normal_BY.RData")
...
ggplot(dpz,aes(x=x))+geom_line(aes(y=y),lwd=2)+
  ...
  geom_vline(data = data.frame(xint=28,type="p-value",ID="40"), color="gold", aes(xintercept = xint),lwd=1.5,linetype="dashed")+
  geom_vline(data = data.frame(xint=67,type="p-value",ID="80"), color="gold", aes(xintercept = xint),lwd=1.5,linetype="dashed")+
  geom_vline(data = data.frame(xint=108,type="p-value",ID="120"), color="gold", aes(xintercept = xint),lwd=1.5,linetype="dashed")+
  geom_vline(data = data.frame(xint=53,type="p-value",ID="40"), color="gold", aes(xintercept = xint),lwd=1.5,linetype="dashed")+
  geom_vline(data = data.frame(xint=94,type="p-value",ID="80"), color="gold", aes(xintercept = xint),lwd=1.5,linetype="dashed")+
  geom_vline(data = data.frame(xint=134,type="p-value",ID="120"), color="gold", aes(xintercept = xint),lwd=1.5,linetype="dashed")+
