...
#'
#' Locally change-point detection after accommodating the bcpw approach in LACPD procedure
#'
#'
#'
...
#'
#' @seealso
#' \link[modifiedmk]{bcpw}, \link[stats]{p.adjust}
#'
#' @examples
#' x <- rnorm(100)
#' Z <- lacpd_bcpw(x,m=50,k=c(3:5))
