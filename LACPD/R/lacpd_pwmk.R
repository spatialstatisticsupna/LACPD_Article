#' Locally change-point detection using the pwmk approach
#'
#' Locally change-point detection after accommodating the pwmk approach in LACPD procedure
#'
#'
#'
...
#'
#' @details
#' This technique accommodates the \link[modifiedmk]{pwmk} trend detection method in the LACPD procedure of Moradi et al. (2020) to look for potential change-points in the numerical vector x.
#'
